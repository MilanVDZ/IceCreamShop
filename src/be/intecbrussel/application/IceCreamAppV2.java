...
public class IceCreamAppV2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Cone.Flavor[] balls = {
                Cone.Flavor.LEMON, Cone.Flavor.BANANA, Cone.Flavor.STRACIATELLA, Cone.Flavor.STRAWBERRY,Cone.Flavor.PISTACHE
            };
            ...
            System.out.println(noMoreIceCreamException.getMessage());
